...
const contactMe = () => {
  window.location.href = "mailto:1043744584@qq.com";
};
</script>
...
<template>
  <div>
    <!-- about -->
    <div class="about">
      <a class="bg_links social portfolio" href="https://zhouyu2156.gitee.io/" target="_blank">
    ...
    <!-- <nav>
      <div class="menu">
        <p class="website_name">
          <a href="https://haiyongcsdn.gitee.io/">
            <img src="/rabbit.svg" alt="" style="width: 32; height: 32px;background: transparent;">
          </a>
        </p>
        <div class="menu_links">
          <a href="https://github.com/ZhouYu2156/vitepress-theme-teek-docs/" class="link">源代码</a>
        </div>
        <div class="menu_icon">
          <span class="icon"></span>
        </div>
